...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "project-dragon-2019-e3f6ead0cfb0 .json"
         ...
         # already present
            for augment_idx in range(0, int(ceil((tot_aug_img-len(nbr_files))/len(nbr_files)))):
                try:
                    ...
                    image=image[...,:3] #to open image with  pil png with 4 channel
...
def preprocess_automl(dataset_name,
    ...
    # version = 2
    # print("Augmentation size: ",aug_size)
    # Clean directory
